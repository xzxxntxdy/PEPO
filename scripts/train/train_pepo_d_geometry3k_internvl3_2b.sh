...
MODEL_ID="${MODEL_ID:-OpenGVLab/InternVL3-2B-Instruct}"
GEOMETRY_IMAGE_ROOT="${GEOMETRY_IMAGE_ROOT:-${DEFAULT_IMAGE_ROOT}}"
MASTER_PORT="${MASTER_PORT:-12349}"
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5,6,7}"
NPROC_PER_NODE="${NPROC_PER_NODE:-8}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/pepo_d/geometry3k/internvl3_2b}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-pepo_d_geometry3k_internvl3_2b}"
